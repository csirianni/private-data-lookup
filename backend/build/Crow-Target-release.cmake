...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET Crow::Crow
                 ...
                 $<$<CONFIG:Release>:${crowcpp-crow_LINKER_FLAGS_RELEASE}> APPEND)
    set_property(TARGET Crow::Crow
                 PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${crowcpp-crow_INCLUDE_DIRS_RELEASE}> APPEND)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET Crow::Crow
                 PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${crowcpp-crow_LIB_DIRS_RELEASE}> APPEND)
    set_property(TARGET Crow::Crow
                 PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${crowcpp-crow_COMPILE_DEFINITIONS_RELEASE}> APPEND)
    set_property(TARGET Crow::Crow
                 PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${crowcpp-crow_COMPILE_OPTIONS_RELEASE}> APPEND)
